...
<head>
    ...
    <title>Nasgorskripsi.id | Pengaduan</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            include 'koneksi.php';
            $tampil = mysqli_query($koneksi, "SELECT * from complaint");
            ?>
                    ...
                    <div class="row">
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        <td scope="col"><?= $row["nama_depan"]; ?></td>
                                        <td scope="col"><?= $row["nama_belakang"]; ?></td>
