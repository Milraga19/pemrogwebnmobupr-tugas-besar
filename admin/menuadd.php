...
<head>
    ...
    <title>Nasgorskripsi.id | Tambah Data Menu</title>
                ...
                <section class="content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="inputPrice" name="product_price" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputName">Product Description</label>
                                        <input type="text" id="inputName" name="product_desc" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputDescription">Product Details</label>
                                        <textarea id="inputDescription" name="product_details" class="form-control" rows="4"></textarea>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <button type="submit" name="tambah" class="btn btn-success float-right">Tambah Menu</button>
                        </div>
                    </div>
                </section>
            </form>
